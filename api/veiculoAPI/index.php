...
/**
 * EndPoint: Responsável por trazer uma lista com os veículos ESTACIONADOS e PLACA específica
 * @author Thales Santos
 * @param String $placa Placa do veiculo
 * @return JSON Dados encontrados
 */
$app->get('/veiculo/estacionados/{placa}', function($request, $response, $args){
